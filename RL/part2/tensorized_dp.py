...
class TensorDP:
    ...
    def set_env(self, env, policy=None):
        ...
        if policy is None:
            ...
            print(self.policy,"this is policy",self.policy.shape,"this is size of policy")
        self.ns = env.nS
        self.na = env.nA
        ...
        print(self.P,"this is P",env.P_tensor.shape,"this is size of P")
        print(self.R,"this is R",env.R_tensor.shape,"this is size of R")
